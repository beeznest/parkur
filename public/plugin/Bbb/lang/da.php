...
$strings['No recording'] = 'Ingen optagelse';
...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Gennemgå møder, optagelser og tilgængelige handlinger.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Vælg de PDF- eller PPTX-filer, du vil indlæse som slides til konferencen.';
$strings['Max total: %d MB'] = 'Maks. i alt: %d MB';
$strings['Pre-upload Documents'] = 'Forudindlæs dokumenter';
$strings['No documents found'] = 'Ingen dokumenter fundet';
$strings['Failed to load documents'] = 'Kunne ikke indlæse dokumenter';
$strings['No meetings or recordings are available yet.'] = 'Ingen møder eller optagelser er tilgængelige endnu.';
$strings['Share the conference link with allowed participants.'] = 'Del konference-linket med tilladte deltagere.';
$strings['WebhooksDashboard'] = 'Webhooks-dashboard (global)';
$strings['MeetingTitleContains'] = 'Mødetitel indeholder';
$strings['FromUTC'] = 'Fra (UTC)';
$strings['ToUTC'] = 'Til (UTC)';
$strings['OnlyOnlineRows'] = 'Kun online-rækker';
$strings['AllMeetings'] = 'Alle møder';
$strings['Apply'] = 'Anvend';
$strings['ExportCSV'] = 'Eksportér CSV';
$strings['AutoRefresh10s'] = 'Auto-opdatering (10s)';
$strings['ActiveMeetings'] = 'Aktive møder';
$strings['ConnectedNow'] = 'Forbundet nu';
$strings['JoinsToday'] = 'Deltagere i dag';
$strings['Events24h'] = 'Begivenheder (24t)';
$strings['OnlineTime'] = 'Online-tid';
$strings['Conversation'] = 'Samtale';
$strings['CameraShare'] = 'Kamera-deling';
$strings['Messages'] = 'Beskeder';
$strings['Reactions'] = 'Reaktioner';
$strings['Hands'] = 'Hænder';
$strings['Results'] = 'Resultater';
$strings['Status'] = 'Status';
$strings['Joined'] = 'Deltog';
$strings['Last'] = 'Sidste';
$strings['Running'] = 'Kører';
$strings['Finished'] = 'Afsluttet';
$strings['UsersColon'] = 'Brugere:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Taler:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Opdateret';
$strings['FirstJoin'] = 'Første deltagelse';
$strings['LastSeen'] = 'Sidst set';
$strings['Totals'] = 'Totaler';
$strings['Talking'] = 'Taler';
$strings['User'] = 'Bruger';
