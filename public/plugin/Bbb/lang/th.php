...
$strings['No recording'] = 'ไม่มีบันทึก';
...
$strings['NoRecording'] = 'ไม่มีการบันทึก';
$strings['presentation'] = 'การนำเสนอ';
$strings['video'] = 'วิดีโอ';
$strings['Review meetings, recordings and available actions.'] = 'ตรวจสอบการประชุม บันทึกการประชุม และการดำเนินการที่ใช้ได้';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'เลือกไฟล์ PDF หรือ PPTX ที่คุณต้องการโหลดล่วงหน้าเป็นสไลด์สำหรับการประชุม';
$strings['Max total: %d MB'] = 'ขนาดรวมสูงสุด: %d MB';
$strings['Pre-upload Documents'] = 'เอกสารที่อัปโหลดล่วงหน้า';
$strings['No documents found'] = 'ไม่พบเอกสาร';
$strings['Failed to load documents'] = 'ไม่สามารถโหลดเอกสารได้';
$strings['No meetings or recordings are available yet.'] = 'ยังไม่มีประชุมหรือบันทึกการประชุม';
$strings['Share the conference link with allowed participants.'] = 'แชร์ลิงก์การประชุมกับผู้เข้าร่วมที่ได้รับอนุญาต';
$strings['WebhooksDashboard'] = 'แดชบอร์ด Webhooks (ทั่วโลก)';
$strings['MeetingTitleContains'] = 'ชื่อการประชุมมีคำว่า';
$strings['FromUTC'] = 'จาก (UTC)';
$strings['ToUTC'] = 'ถึง (UTC)';
$strings['OnlyOnlineRows'] = 'เฉพาะแถวที่ออนไลน์';
$strings['AllMeetings'] = 'การประชุมทั้งหมด';
$strings['Apply'] = 'นำไปใช้';
$strings['ExportCSV'] = 'ส่งออก CSV';
$strings['AutoRefresh10s'] = 'รีเฟรชอัตโนมัติ (10 วินาที)';
$strings['ActiveMeetings'] = 'การประชุมที่กำลังดำเนินอยู่';
$strings['ConnectedNow'] = 'เชื่อมต่ออยู่ขณะนี้';
$strings['JoinsToday'] = 'เข้าร่วมวันนี้';
$strings['Events24h'] = 'เหตุการณ์ (24 ชม.)';
$strings['OnlineTime'] = 'เวลาออนไลน์';
$strings['Conversation'] = 'การสนทนา';
$strings['CameraShare'] = 'แชร์กล้อง';
$strings['Messages'] = 'ข้อความ';
$strings['Reactions'] = 'ปฏิกิริยา';
$strings['Hands'] = 'ยกมือ';
$strings['Results'] = 'ผลลัพธ์';
$strings['Status'] = 'สถานะ';
$strings['Joined'] = 'เข้าร่วมแล้ว';
$strings['Last'] = 'ล่าสุด';
$strings['Running'] = 'กำลังดำเนินการ';
$strings['Finished'] = 'เสร็จสิ้น';
$strings['UsersColon'] = 'ผู้ใช้:';
$strings['OnlineColon'] = 'ออนไลน์:';
$strings['TalkColon'] = 'พูดคุย:';
$strings['CameraColon'] = 'กล้อง:';
$strings['Updated'] = 'อัปเดตเมื่อ';
$strings['FirstJoin'] = 'เข้าร่วมครั้งแรก';
$strings['LastSeen'] = 'เห็นล่าสุด';
$strings['Totals'] = 'รวมทั้งหมด';
$strings['Talking'] = 'กำลังพูด';
$strings['User'] = 'ผู้ใช้';
