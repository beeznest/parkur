...
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Seleccione los archivos PDF o PPTX que desea precargar como diapositivas para la conferencia.';
$strings['Max total: %d MB'] = 'Máximo total: %d MB';
$strings['Pre-upload Documents'] = 'Precargar documentos';
$strings['No documents found'] = 'No se encontraron documentos';
$strings['Failed to load documents'] = 'Error al cargar los documentos';
$strings['No meetings or recordings are available yet.'] = 'Aún no hay reuniones ni grabaciones disponibles.';
$strings['Share the conference link with allowed participants.'] = 'Comparta el enlace de la conferencia con los participantes autorizados.';
$strings['presentation'] = 'Presentacion';
$strings['video'] = 'Video';
$strings['WebhooksDashboard'] = 'Panel de Webhooks (Global)';
$strings['MeetingTitleContains'] = 'El título de la reunión contiene';
$strings['FromUTC'] = 'Desde (UTC)';
$strings['ToUTC'] = 'Hasta (UTC)';
$strings['OnlyOnlineRows'] = 'Solo filas en línea';
$strings['AllMeetings'] = 'Todas las reuniones';
$strings['Apply'] = 'Aplicar';
$strings['ExportCSV'] = 'Exportar CSV';
$strings['AutoRefresh10s'] = 'Actualización automática (10s)';
$strings['ActiveMeetings'] = 'Reuniones activas';
$strings['ConnectedNow'] = 'Conectados ahora';
$strings['JoinsToday'] = 'Uniones hoy';
$strings['Events24h'] = 'Eventos (24h)';
$strings['OnlineTime'] = 'Tiempo en línea';
$strings['Conversation'] = 'Conversación';
$strings['CameraShare'] = 'Compartir cámara';
$strings['Messages'] = 'Mensajes';
$strings['Reactions'] = 'Reacciones';
$strings['Hands'] = 'Manos';
$strings['Results'] = 'Resultados';
$strings['Status'] = 'Estado';
$strings['Joined'] = 'Se unió';
$strings['Last'] = 'Último';
$strings['Running'] = 'En curso';
$strings['Finished'] = 'Finalizada';
$strings['UsersColon'] = 'Usuarios:';
$strings['OnlineColon'] = 'En línea:';
$strings['TalkColon'] = 'Hablando:';
$strings['CameraColon'] = 'Cámara:';
$strings['Updated'] = 'Actualizado';
$strings['FirstJoin'] = 'Primera unión';
$strings['LastSeen'] = 'Última vez visto';
$strings['Totals'] = 'Totales';
$strings['Talking'] = 'Hablando';
$strings['User'] = 'Usuario';
$strings['No recording'] = 'No hay grabación';
