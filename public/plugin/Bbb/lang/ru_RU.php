...
$strings['NoRecording'] = 'Нет записи';
$strings['presentation'] = 'Презентация';
$strings['video'] = 'Видео';
$strings['Review meetings, recordings and available actions.'] = 'Просмотр встреч, записей и доступных действий.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Выберите PDF или PPTX файлы, которые вы хотите предварительно загрузить в качестве слайдов для конференции.';
$strings['Max total: %d MB'] = 'Макс. всего: %d МБ';
$strings['Pre-upload Documents'] = 'Предварительная загрузка документов';
$strings['No documents found'] = 'Документы не найдены';
$strings['Failed to load documents'] = 'Не удалось загрузить документы';
$strings['No meetings or recordings are available yet.'] = 'Встречи и записи пока отсутствуют.';
$strings['Share the conference link with allowed participants.'] = 'Поделитесь ссылкой на конференцию с разрешёнными участниками.';
$strings['WebhooksDashboard'] = 'Панель вебхуков (глобальная)';
$strings['MeetingTitleContains'] = 'Название встречи содержит';
$strings['FromUTC'] = 'С (UTC)';
$strings['ToUTC'] = 'По (UTC)';
$strings['OnlyOnlineRows'] = 'Только онлайн';
$strings['AllMeetings'] = 'Все встречи';
$strings['Apply'] = 'Применить';
$strings['ExportCSV'] = 'Экспорт CSV';
$strings['AutoRefresh10s'] = 'Автообновление (10с)';
$strings['ActiveMeetings'] = 'Активные встречи';
$strings['ConnectedNow'] = 'Подключено сейчас';
$strings['JoinsToday'] = 'Подключений сегодня';
$strings['Events24h'] = 'Событий (24ч)';
$strings['OnlineTime'] = 'Время онлайн';
$strings['Conversation'] = 'Разговор';
$strings['CameraShare'] = 'Камера';
$strings['Messages'] = 'Сообщения';
$strings['Reactions'] = 'Реакции';
$strings['Hands'] = 'Поднятые руки';
$strings['Results'] = 'Результаты';
$strings['Status'] = 'Статус';
$strings['Joined'] = 'Присоединился';
$strings['Last'] = 'Последний';
$strings['Running'] = 'Выполняется';
$strings['Finished'] = 'Завершена';
$strings['UsersColon'] = 'Пользователи:';
$strings['OnlineColon'] = 'Онлайн:';
$strings['TalkColon'] = 'Разговор:';
$strings['CameraColon'] = 'Камера:';
$strings['Updated'] = 'Обновлено';
$strings['FirstJoin'] = 'Первое подключение';
$strings['LastSeen'] = 'Последний раз в сети';
$strings['Totals'] = 'Итого';
$strings['Talking'] = 'Говорит';
