...
$strings['No recording'] = 'Ingen opptak';
...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Sjå gjennom møte, opptak og tilgjengelege handlingar.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Vel PDF- eller PPTX-filene du vil førehandslaste som lysbilete for konferansen.';
$strings['Max total: %d MB'] = 'Maks totalt: %d MB';
$strings['Pre-upload Documents'] = 'Førehandsopplasting av dokument';
$strings['No documents found'] = 'Fann ingen dokument';
$strings['Failed to load documents'] = 'Klarte ikkje å laste dokument';
$strings['No meetings or recordings are available yet.'] = 'Ingen møte eller opptak er tilgjengelege enno.';
$strings['Share the conference link with allowed participants.'] = 'Del konferanselenkja med godkjende deltakarar.';
$strings['WebhooksDashboard'] = 'Webhooks-dashbord (globalt)';
$strings['MeetingTitleContains'] = 'Møtetittel inneheld';
$strings['FromUTC'] = 'Frå (UTC)';
$strings['ToUTC'] = 'Til (UTC)';
$strings['OnlyOnlineRows'] = 'Berre online-rader';
$strings['AllMeetings'] = 'Alle møte';
$strings['Apply'] = 'Bruk';
$strings['ExportCSV'] = 'Eksporter CSV';
$strings['AutoRefresh10s'] = 'Auto-oppdatering (10 s)';
$strings['ActiveMeetings'] = 'Aktive møte';
$strings['ConnectedNow'] = 'Kopla til no';
$strings['JoinsToday'] = 'Deltakarar i dag';
$strings['Events24h'] = 'Hendingar (24 t)';
$strings['OnlineTime'] = 'Online-tid';
$strings['Conversation'] = 'Samtale';
$strings['CameraShare'] = 'Kameradeling';
$strings['Messages'] = 'Meldingar';
$strings['Reactions'] = 'Reaksjonar';
$strings['Hands'] = 'Hender';
$strings['Results'] = 'Resultat';
$strings['Status'] = 'Status';
$strings['Joined'] = 'Delta';
$strings['Last'] = 'Siste';
$strings['Running'] = 'Køyrer';
$strings['Finished'] = 'Fullført';
$strings['UsersColon'] = 'Brukarar:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Snakkar:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Oppdatert';
$strings['FirstJoin'] = 'Første deltaking';
$strings['LastSeen'] = 'Sist sett';
$strings['Totals'] = 'Totalt';
$strings['Talking'] = 'Snakkar';
$strings['User'] = 'Brukar';
