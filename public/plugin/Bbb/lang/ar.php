...
$strings['video'] = 'فيديو';
$strings['Review meetings, recordings and available actions.'] = 'مراجعة الاجتماعات والتسجيلات والإجراءات المتاحة.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'حدد ملفات PDF أو PPTX التي تريد تحميلها مسبقًا كشرائح للمؤتمر.';
$strings['Max total: %d MB'] = 'الحد الأقصى الإجمالي: %d ميجابايت';
$strings['Pre-upload Documents'] = 'تحميل المستندات مسبقًا';
$strings['No documents found'] = 'لم يتم العثور على مستندات';
$strings['Failed to load documents'] = 'فشل تحميل المستندات';
$strings['No meetings or recordings are available yet.'] = 'لا توجد اجتماعات أو تسجيلات متاحة حتى الآن.';
$strings['Share the conference link with allowed participants.'] = 'شارك رابط المؤتمر مع المشاركين المسموح لهم.';
$strings['WebhooksDashboard'] = 'لوحة تحكم Webhooks (عالمية)';
$strings['MeetingTitleContains'] = 'عنوان الاجتماع يحتوي على';
$strings['FromUTC'] = 'من (UTC)';
$strings['ToUTC'] = 'إلى (UTC)';
$strings['OnlyOnlineRows'] = 'الصفوف المتصلة فقط';
$strings['AllMeetings'] = 'جميع الاجتماعات';
$strings['Apply'] = 'تطبيق';
$strings['ExportCSV'] = 'تصدير CSV';
$strings['AutoRefresh10s'] = 'تحديث تلقائي (10 ثانية)';
$strings['ActiveMeetings'] = 'الاجتماعات النشطة';
$strings['ConnectedNow'] = 'متصلون الآن';
$strings['JoinsToday'] = 'انضمامات اليوم';
$strings['Events24h'] = 'الأحداث (24 ساعة)';
$strings['OnlineTime'] = 'وقت الاتصال';
$strings['Conversation'] = 'المحادثة';
$strings['CameraShare'] = 'مشاركة الكاميرا';
$strings['Messages'] = 'الرسائل';
$strings['Reactions'] = 'التفاعلات';
$strings['Hands'] = 'الأيدي المرفوعة';
$strings['Results'] = 'النتائج';
$strings['Status'] = 'الحالة';
$strings['Joined'] = 'انضم';
$strings['Last'] = 'الأخير';
$strings['Running'] = 'جاري التشغيل';
$strings['Finished'] = 'انتهى';
$strings['UsersColon'] = 'المستخدمون:';
$strings['OnlineColon'] = 'متصلون:';
$strings['TalkColon'] = 'يتحدث:';
$strings['CameraColon'] = 'الكاميرا:';
$strings['Updated'] = 'تم التحديث';
$strings['FirstJoin'] = 'أول انضمام';
$strings['LastSeen'] = 'آخر ظهور';
$strings['Totals'] = 'الإجماليات';
$strings['Talking'] = 'يتحدث';
$strings['User'] = 'المستخدم';
