...
$strings['No recording'] = 'Žiadna nahrávka';
...
$strings['NoRecording'] = 'Ziadna nahravka';
$strings['presentation'] = 'Prezentacia';
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Prezerajte si stretnutia, nahrávky a dostupné akcie.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Vyberte súbory PDF alebo PPTX, ktoré chcete prednahrať ako snímky pre konferenciu.';
$strings['Max total: %d MB'] = 'Maximálny celkový objem: %d MB';
$strings['Pre-upload Documents'] = 'Prednahrať dokumenty';
$strings['No documents found'] = 'Nenašli sa žiadne dokumenty';
$strings['Failed to load documents'] = 'Nepodarilo sa načítať dokumenty';
$strings['No meetings or recordings are available yet.'] = 'Zatiaľ nie sú dostupné žiadne stretnutia ani nahrávky.';
$strings['Share the conference link with allowed participants.'] = 'Zdielajte odkaz na konferenciu s oprávnenými účastníkmi.';
$strings['WebhooksDashboard'] = 'Webhooks Dashboard (Globálne)';
$strings['MeetingTitleContains'] = 'Názov stretnutia obsahuje';
$strings['FromUTC'] = 'Od (UTC)';
$strings['ToUTC'] = 'Do (UTC)';
$strings['OnlyOnlineRows'] = 'Iba online riadky';
$strings['AllMeetings'] = 'Všetky stretnutia';
$strings['Apply'] = 'Použiť';
$strings['ExportCSV'] = 'Exportovať CSV';
$strings['AutoRefresh10s'] = 'Automatická obnova (10s)';
$strings['ActiveMeetings'] = 'Aktívne stretnutia';
$strings['ConnectedNow'] = 'Pripojení teraz';
$strings['JoinsToday'] = 'Pripojenia dnes';
$strings['Events24h'] = 'Udalosti (24h)';
$strings['OnlineTime'] = 'Čas online';
$strings['Conversation'] = 'Konverzácia';
$strings['CameraShare'] = 'Zdielanie kamery';
$strings['Messages'] = 'Správy';
$strings['Reactions'] = 'Reakcie';
$strings['Hands'] = 'Ruky';
$strings['Results'] = 'Výsledky';
$strings['Status'] = 'Stav';
$strings['Joined'] = 'Pripojený';
$strings['Last'] = 'Posledný';
$strings['Running'] = 'Prebieha';
$strings['Finished'] = 'Ukončené';
$strings['UsersColon'] = 'Používatelia:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Hovor:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Aktualizované';
$strings['FirstJoin'] = 'Prvé pripojenie';
$strings['LastSeen'] = 'Naposledy videný';
$strings['Totals'] = 'Celkom';
$strings['Talking'] = 'Hovorí';
$strings['User'] = 'Používateľ';
