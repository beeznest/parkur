...
$strings['video'] = '视频';
$strings['Review meetings, recordings and available actions.'] = '查看会议、录像和可用操作。';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = '选择要预加载为会议幻灯片的 PDF 或 PPTX 文件。';
$strings['Max total: %d MB'] = '最大总大小：%d MB';
$strings['Pre-upload Documents'] = '预上传文档';
$strings['No documents found'] = '未找到文档';
$strings['Failed to load documents'] = '加载文档失败';
$strings['No meetings or recordings are available yet.'] = '暂无可用会议或录像。';
$strings['Share the conference link with allowed participants.'] = '将会议链接分享给允许的参与者。';
$strings['WebhooksDashboard'] = 'Webhooks 仪表板（全局）';
$strings['MeetingTitleContains'] = '会议标题包含';
$strings['FromUTC'] = '开始时间 (UTC)';
$strings['ToUTC'] = '结束时间 (UTC)';
$strings['OnlyOnlineRows'] = '仅在线记录';
$strings['AllMeetings'] = '所有会议';
$strings['Apply'] = '应用';
$strings['ExportCSV'] = '导出 CSV';
$strings['AutoRefresh10s'] = '自动刷新 (10秒)';
$strings['ActiveMeetings'] = '进行中的会议';
$strings['ConnectedNow'] = '当前在线';
$strings['JoinsToday'] = '今日加入';
$strings['Events24h'] = '事件 (24小时)';
$strings['OnlineTime'] = '在线时长';
$strings['Conversation'] = '对话';
$strings['CameraShare'] = '摄像头共享';
$strings['Messages'] = '消息';
$strings['Reactions'] = '反应';
$strings['Hands'] = '举手';
$strings['Results'] = '结果';
$strings['Status'] = '状态';
$strings['Joined'] = '已加入';
...
$strings['UsersColon'] = '用户：';
$strings['OnlineColon'] = '在线：';
$strings['TalkColon'] = '发言：';
$strings['CameraColon'] = '摄像头：';
$strings['Updated'] = '已更新';
$strings['FirstJoin'] = '首次加入';
$strings['LastSeen'] = '最后出现';
$strings['Totals'] = '总计';
$strings['Talking'] = '正在发言';
$strings['User'] = '用户';
