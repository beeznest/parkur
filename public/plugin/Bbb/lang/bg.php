...
$strings['salt'] = 'BigBlueButton сол';
...
$strings['No recording'] = 'Няма запис';
...
$strings['video'] = 'Видео';
$strings['Review meetings, recordings and available actions.'] = 'Преглед на срещи, записи и налични действия.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Изберете PDF или PPTX файловете, които искате да заредите предварително като слайдове за конференцията.';
$strings['Max total: %d MB'] = 'Максимално общо: %d MB';
$strings['Pre-upload Documents'] = 'Предварително качени документи';
$strings['No documents found'] = 'Няма намерени документи';
$strings['Failed to load documents'] = 'Неуспешно зареждане на документи';
$strings['No meetings or recordings are available yet.'] = 'Все още няма налични срещи или записи.';
$strings['Share the conference link with allowed participants.'] = 'Споделете връзката към конференцията с разрешените участници.';
$strings['WebhooksDashboard'] = 'Табло за уебхукове (Глобално)';
$strings['MeetingTitleContains'] = 'Заглавието на срещата съдържа';
$strings['FromUTC'] = 'От (UTC)';
$strings['ToUTC'] = 'До (UTC)';
$strings['OnlyOnlineRows'] = 'Само онлайн редове';
$strings['AllMeetings'] = 'Всички срещи';
$strings['Apply'] = 'Приложи';
$strings['ExportCSV'] = 'Експорт в CSV';
$strings['AutoRefresh10s'] = 'Автообновяване (10s)';
$strings['ActiveMeetings'] = 'Активни срещи';
$strings['ConnectedNow'] = 'Свързани в момента';
$strings['JoinsToday'] = 'Присъединявания днес';
$strings['Events24h'] = 'Събития (24ч)';
$strings['OnlineTime'] = 'Време онлайн';
$strings['Conversation'] = 'Разговор';
$strings['CameraShare'] = 'Споделяне на камера';
$strings['Messages'] = 'Съобщения';
$strings['Reactions'] = 'Реакции';
$strings['Hands'] = 'Вдигнати ръце';
$strings['Results'] = 'Резултати';
$strings['Status'] = 'Статус';
$strings['Joined'] = 'Присъединил се';
$strings['Last'] = 'Последно';
$strings['Running'] = 'В процес';
$strings['Finished'] = 'Завършена';
$strings['UsersColon'] = 'Потребители:';
$strings['OnlineColon'] = 'Онлайн:';
$strings['TalkColon'] = 'Говорене:';
$strings['CameraColon'] = 'Камера:';
$strings['Updated'] = 'Обновено';
$strings['FirstJoin'] = 'Първо присъединяване';
$strings['LastSeen'] = 'Последно видян';
$strings['Totals'] = 'Общо';
$strings['Talking'] = 'Говори';
