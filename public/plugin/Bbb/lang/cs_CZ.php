...
$strings['No recording'] = 'Žádná nahrávka';
...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Prohlédněte si schůzky, nahrávky a dostupné akce.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Vyberte soubory PDF nebo PPTX, které chcete předem načíst jako snímky pro konferenci.';
$strings['Max total: %d MB'] = 'Maximální celková velikost: %d MB';
$strings['Pre-upload Documents'] = 'Předem nahrané dokumenty';
$strings['No documents found'] = 'Nenalezeny žádné dokumenty';
$strings['Failed to load documents'] = 'Nepodařilo se načíst dokumenty';
$strings['No meetings or recordings are available yet.'] = 'Zatím nejsou k dispozici žádné schůzky ani nahrávky.';
$strings['Share the conference link with allowed participants.'] = 'Sdílejte odkaz na konferenci s oprávněnými účastníky.';
$strings['WebhooksDashboard'] = 'Řídicí panel webhooků (globální)';
$strings['MeetingTitleContains'] = 'Název schůzky obsahuje';
$strings['FromUTC'] = 'Od (UTC)';
$strings['ToUTC'] = 'Do (UTC)';
$strings['OnlyOnlineRows'] = 'Pouze online řádky';
$strings['AllMeetings'] = 'Všechny schůzky';
$strings['Apply'] = 'Použít';
$strings['ExportCSV'] = 'Exportovat CSV';
$strings['AutoRefresh10s'] = 'Automatické obnovování (10s)';
$strings['ActiveMeetings'] = 'Aktivní schůzky';
$strings['ConnectedNow'] = 'Nyní připojeno';
$strings['JoinsToday'] = 'Připojení dnes';
$strings['Events24h'] = 'Události (24h)';
$strings['OnlineTime'] = 'Online čas';
$strings['Conversation'] = 'Konverzace';
$strings['CameraShare'] = 'Sdílení kamery';
$strings['Messages'] = 'Zprávy';
$strings['Reactions'] = 'Reakce';
$strings['Hands'] = 'Ruce';
$strings['Results'] = 'Výsledky';
$strings['Status'] = 'Stav';
$strings['Joined'] = 'Připojen';
$strings['Last'] = 'Poslední';
$strings['Running'] = 'Probíhá';
$strings['Finished'] = 'Dokončeno';
$strings['UsersColon'] = 'Uživatelé:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Mluví:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Aktualizováno';
$strings['FirstJoin'] = 'První připojení';
$strings['LastSeen'] = 'Naposledy viděn';
$strings['Totals'] = 'Celkem';
$strings['Talking'] = 'Mluví';
