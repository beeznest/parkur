...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Tarkastele kokouksia, tallenteita ja käytettävissä olevia toimintoja.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Valitse PDF- tai PPTX-tiedostot, jotka haluat esiladata diaesityksiksi konferenssiin.';
$strings['Max total: %d MB'] = 'Enimmäismäärä yhteensä: %d Mt';
$strings['Pre-upload Documents'] = 'Esilataa asiakirjoja';
$strings['No documents found'] = 'Asiakirjoja ei löytynyt';
$strings['Failed to load documents'] = 'Asiakirjojen lataaminen epäonnistui';
$strings['No meetings or recordings are available yet.'] = 'Kokouksia tai tallenteita ei ole vielä saatavilla.';
$strings['Share the conference link with allowed participants.'] = 'Jaa konferenssilinkki sallituille osallistujille.';
$strings['WebhooksDashboard'] = 'Webhooks-hallintapaneeli (Globaali)';
$strings['MeetingTitleContains'] = 'Kokouksen otsikko sisältää';
$strings['FromUTC'] = 'Alkaen (UTC)';
$strings['ToUTC'] = 'Päättyen (UTC)';
$strings['OnlyOnlineRows'] = 'Vain online-rivit';
$strings['AllMeetings'] = 'Kaikki kokoukset';
$strings['Apply'] = 'Käytä';
$strings['ExportCSV'] = 'Vie CSV';
$strings['AutoRefresh10s'] = 'Automaattinen päivitys (10s)';
$strings['ActiveMeetings'] = 'Aktiiviset kokoukset';
$strings['ConnectedNow'] = 'Yhdistetty nyt';
$strings['JoinsToday'] = 'Liittymiset tänään';
$strings['Events24h'] = 'Tapahtumat (24h)';
$strings['OnlineTime'] = 'Online-aika';
$strings['Conversation'] = 'Keskustelu';
$strings['CameraShare'] = 'Kameran jako';
$strings['Messages'] = 'Viestit';
$strings['Reactions'] = 'Reaktiot';
$strings['Hands'] = 'Kädet';
$strings['Results'] = 'Tulokset';
$strings['Status'] = 'Tila';
$strings['Joined'] = 'Liittynyt';
$strings['Last'] = 'Viimeisin';
$strings['Running'] = 'Käynnissä';
$strings['Finished'] = 'Päättynyt';
$strings['UsersColon'] = 'Käyttäjät:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Puhe:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Päivitetty';
$strings['FirstJoin'] = 'Ensimmäinen liittyminen';
$strings['LastSeen'] = 'Viimeksi nähty';
$strings['Totals'] = 'Yhteensä';
$strings['Talking'] = 'Puhetta';
