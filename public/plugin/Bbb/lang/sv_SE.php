...
$strings['No recording'] = 'Ingen inspelning';
...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Granska möten, inspelningar och tillgängliga åtgärder.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Välj de PDF- eller PPTX-filer du vill förladda som bildspel för konferensen.';
$strings['Max total: %d MB'] = 'Max totalt: %d MB';
$strings['Pre-upload Documents'] = 'Förladda dokument';
$strings['No documents found'] = 'Inga dokument hittades';
$strings['Failed to load documents'] = 'Kunde inte ladda dokument';
$strings['No meetings or recordings are available yet.'] = 'Inga möten eller inspelningar är tillgängliga ännu.';
$strings['Share the conference link with allowed participants.'] = 'Dela konferenslänken med tillåtna deltagare.';
$strings['WebhooksDashboard'] = 'Webhooks-instrumentpanel (Global)';
$strings['MeetingTitleContains'] = 'Mötestitel innehåller';
$strings['FromUTC'] = 'Från (UTC)';
$strings['ToUTC'] = 'Till (UTC)';
$strings['OnlyOnlineRows'] = 'Endast online-rader';
$strings['AllMeetings'] = 'Alla möten';
$strings['Apply'] = 'Tillämpa';
$strings['ExportCSV'] = 'Exportera CSV';
$strings['AutoRefresh10s'] = 'Auto-uppdatering (10s)';
$strings['ActiveMeetings'] = 'Aktiva möten';
$strings['ConnectedNow'] = 'Anslutna nu';
$strings['JoinsToday'] = 'Anslutningar idag';
$strings['Events24h'] = 'Händelser (24h)';
$strings['OnlineTime'] = 'Online-tid';
$strings['Conversation'] = 'Konversation';
$strings['CameraShare'] = 'Kameradelning';
$strings['Messages'] = 'Meddelanden';
$strings['Reactions'] = 'Reaktioner';
$strings['Hands'] = 'Händer';
$strings['Results'] = 'Resultat';
$strings['Status'] = 'Status';
$strings['Joined'] = 'Anslöt';
$strings['Last'] = 'Senaste';
$strings['Running'] = 'Pågår';
$strings['Finished'] = 'Avslutad';
$strings['UsersColon'] = 'Användare:';
$strings['OnlineColon'] = 'Online:';
$strings['TalkColon'] = 'Tal:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Uppdaterad';
$strings['FirstJoin'] = 'Första anslutning';
$strings['LastSeen'] = 'Senast sedd';
$strings['Totals'] = 'Totalt';
$strings['Talking'] = 'Pratar';
