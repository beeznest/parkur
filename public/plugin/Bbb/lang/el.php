...
$strings['Review meetings, recordings and available actions.'] = 'Επισκόπηση συναντήσεων, καταγραφών και διαθέσιμων ενεργειών.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Επιλέξτε τα αρχεία PDF ή PPTX που θέλετε να προφορτώσετε ως διαφάνειες για τη διάσκεψη.';
$strings['Max total: %d MB'] = 'Μέγιστο σύνολο: %d MB';
$strings['Pre-upload Documents'] = 'Προφόρτωση εγγράφων';
$strings['No documents found'] = 'Δεν βρέθηκαν έγγραφα';
$strings['Failed to load documents'] = 'Αποτυχία φόρτωσης εγγράφων';
$strings['No meetings or recordings are available yet.'] = 'Δεν υπάρχουν ακόμη διαθέσιμες συναντήσεις ή καταγραφές.';
$strings['Share the conference link with allowed participants.'] = 'Κοινοποιήστε τον σύνδεσμο της διάσκεψης στους εγκεκριμένους συμμετέχοντες.';
$strings['WebhooksDashboard'] = 'Πίνακας ελέγχου Webhooks (Καθολικός)';
$strings['MeetingTitleContains'] = 'Ο τίτλος της συνάντησης περιέχει';
$strings['FromUTC'] = 'Από (UTC)';
$strings['ToUTC'] = 'Έως (UTC)';
$strings['OnlyOnlineRows'] = 'Μόνο συνδεδεμένες γραμμές';
$strings['AllMeetings'] = 'Όλες οι συναντήσεις';
$strings['Apply'] = 'Εφαρμογή';
$strings['ExportCSV'] = 'Εξαγωγή CSV';
$strings['AutoRefresh10s'] = 'Αυτόματη ανανέωση (10δ)';
$strings['ActiveMeetings'] = 'Ενεργές συναντήσεις';
$strings['ConnectedNow'] = 'Συνδεδεμένοι τώρα';
$strings['JoinsToday'] = 'Συνδέσεις σήμερα';
$strings['Events24h'] = 'Συμβάντα (24ω)';
$strings['OnlineTime'] = 'Χρόνος σε σύνδεση';
$strings['Conversation'] = 'Συζήτηση';
$strings['CameraShare'] = 'Κοινή χρήση κάμερας';
$strings['Messages'] = 'Μηνύματα';
$strings['Reactions'] = 'Αντιδράσεις';
$strings['Hands'] = 'Χέρια';
$strings['Results'] = 'Αποτελέσματα';
$strings['Status'] = 'Κατάσταση';
$strings['Joined'] = 'Συνδέθηκε';
$strings['Last'] = 'Τελευταίο';
$strings['Running'] = 'Σε εξέλιξη';
$strings['Finished'] = 'Ολοκληρώθηκε';
$strings['UsersColon'] = 'Χρήστες:';
$strings['OnlineColon'] = 'Σε σύνδεση:';
$strings['TalkColon'] = 'Ομιλία:';
$strings['CameraColon'] = 'Κάμερα:';
$strings['Updated'] = 'Ενημερώθηκε';
$strings['FirstJoin'] = 'Πρώτη σύνδεση';
$strings['LastSeen'] = 'Τελευταία εμφάνιση';
$strings['Totals'] = 'Σύνολα';
$strings['Talking'] = 'Μιλάει';
