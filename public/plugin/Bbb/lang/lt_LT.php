...
$strings['No recording'] = 'Nėra įrašo';
...
$strings['video'] = 'Video';
$strings['Review meetings, recordings and available actions.'] = 'Peržiūrėti susitikimus, įrašus ir galimus veiksmus.';
$strings['Select the PDF or PPTX files you want to pre-load as slides for the conference.'] = 'Pasirinkite PDF arba PPTX failus, kuriuos norite iš anksto įkelti kaip skaidres konferencijai.';
$strings['Max total: %d MB'] = 'Maksimalus bendras dydis: %d MB';
$strings['Pre-upload Documents'] = 'Iš anksto įkelti dokumentai';
$strings['No documents found'] = 'Dokumentų nerasta';
$strings['Failed to load documents'] = 'Nepavyko įkelti dokumentų';
$strings['No meetings or recordings are available yet.'] = 'Susitikimų ar įrašų dar nėra.';
$strings['Share the conference link with allowed participants.'] = 'Pasidalinkite konferencijos nuoroda su leidžiamais dalyviais.';
$strings['WebhooksDashboard'] = "Webhook'ų valdymo skydelis (Globalus)";
$strings['MeetingTitleContains'] = 'Susitikimo pavadinimas turi';
$strings['FromUTC'] = 'Nuo (UTC)';
$strings['ToUTC'] = 'Iki (UTC)';
$strings['OnlyOnlineRows'] = 'Tik prisijungusios eilutės';
$strings['AllMeetings'] = 'Visi susitikimai';
$strings['Apply'] = 'Taikyti';
$strings['ExportCSV'] = 'Eksportuoti CSV';
$strings['AutoRefresh10s'] = 'Automatinis atnaujinimas (10s)';
$strings['ActiveMeetings'] = 'Aktyvūs susitikimai';
$strings['ConnectedNow'] = 'Prisijungę dabar';
$strings['JoinsToday'] = 'Prisijungimai šiandien';
$strings['Events24h'] = 'Įvykiai (24 val.)';
$strings['OnlineTime'] = 'Laikas prisijungus';
$strings['Conversation'] = 'Pokalbis';
$strings['CameraShare'] = 'Kameros rodymas';
$strings['Messages'] = 'Žinutės';
$strings['Reactions'] = 'Reakcijos';
$strings['Hands'] = 'Pakeltos rankos';
$strings['Results'] = 'Rezultatai';
$strings['Status'] = 'Būsena';
$strings['Joined'] = 'Prisijungė';
$strings['Last'] = 'Paskutinis';
$strings['Running'] = 'Vyksta';
$strings['Finished'] = 'Baigtas';
$strings['UsersColon'] = 'Vartotojai:';
$strings['OnlineColon'] = 'Prisijungę:';
$strings['TalkColon'] = 'Kalbėjimas:';
$strings['CameraColon'] = 'Kamera:';
$strings['Updated'] = 'Atnaujinta';
$strings['FirstJoin'] = 'Pirmas prisijungimas';
$strings['LastSeen'] = 'Paskutinį kartą matytas';
$strings['Totals'] = 'Iš viso';
$strings['Talking'] = 'Kalbama';
$strings['User'] = 'Vartotojas';
